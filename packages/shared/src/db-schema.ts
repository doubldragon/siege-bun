...
export const cards = sqliteTable("cards", {
  ...
  meleeDefense: integer("melee_defense"),
  rangedDefense: integer("ranged_defense"),
  siegeAttack: integer("siege_attack"),
  wallStrength: integer("wall_strength"),
  sides: integer("sides"),
  effects: text("effects", { mode: "json" }).$type<import("./types").CardEffects>(),
